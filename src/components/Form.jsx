    ...
    return (
        <div className=" flex items-start justify-center bg-gradient-to-r p-20 h-max">
            <motion.div
                ...
                className="bg-white p-8 rounded-lg shadow-lg w-full max-w-[1000px]">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end"> 
                        <motion.button
                            type="submit"
                            className="w-[20%] py-2 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-600 transition disabled:bg-gray-400"
                            whileTap={{ scale: 0.95 }}
                            disabled={loading}
                        >
