    ...
    translation: {
      ...
      footer: {
        first: {
          ...
          phone: "Телефон",
          place: "Адрес: г. Нукус, улица Беруний",
        },
        navs: {
          main: "Главная",
          news: "Новости",
    ...
    translation: {
      ...
      footer: {
        first: {
          ...
          phone: "Phone",
          place: "Address: Nukus city, Bayniy street",
        },
        navs: {
          main: "Home",
          news: "News",
    ...
    translation: {
      ...
      courses: {
        course1: {
          ...
          des1: "Kurs Haqqında",
          p1: "Bul kurs arqalı siz ǵimarattardı loyihalaw, ishki jay dizaynı hám onı bezew boyınsha negizgi teoriyalıq hám práctikalıq bılimge iye bolasız. Práctikalıq sabaqlar 3D modellew, sızba jasaw hám ishki dizayn konsepsiyaların ámelge asıradı.",
          p2: "Siz shınayı layihalar menen jumıs jasaw hám óz portfoliongızdı qurıw imkaniyatına iye bolasız. Sabalar tásirbelik profesionallar tárepinen ótkiziledi.",
